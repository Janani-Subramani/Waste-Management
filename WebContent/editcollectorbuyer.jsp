                    ...
                    <div class="card">/
                       <!--  <div class="card-header">Register</div>-->
                        <div class="card-body">
                            ...
                            String sql = "select * from purchaseorderbuyer where id='"+id+"'";
...
if(a!=null)
{
	String query="update purchaseorderbuyer set name=?,total=?,paid_or_not=?,paymentmode=?,collected_or_not=?,willcollect=?  where id='"+id+"'";
	...
	stmt.setString(6,f);
	stmt.executeUpdate();
	response.sendRedirect("collectorsidebuyer.jsp");
}
%>
