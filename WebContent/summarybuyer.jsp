...
%>
<div class="wrapper">
<form name="summary" action="netorcash.jsp" method="get">
...
<input type="text" name="area"  value="netbanking">
<br>
<br>
...
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
 ...
 PreparedStatement pst1=connection.prepareStatement("select * from purchaseorderbuyer ");
