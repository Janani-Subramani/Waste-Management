...
<form action="buyprocess" method="get">
<div class="wrapper">
<h1 align="center" style="color:black">Buyer</h1>
<%
...
ResultSet resultSet = null,res=null;
%>
<%
try{
...
String sql ="select buyprice from product where productname='paper' ";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>

<h3>Rs <%=resultSet.getString("buyprice") %></h3>
<%
}
connection.close();
} catch (Exception e) {
...
<input type="numeric" id="paper" onkeyup="sync()" placeholder="Enter quantity in kgs" >
...
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
statement=connection.createStatement();
String sql ="select buyprice from product where productname='plastic' ";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
...
<input type="numeric" id="plastic" onkeyup="sync()" placeholder="Enter quantity in kgs">
...
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
statement=connection.createStatement();
String sql ="select buyprice from product where productname='metal' ";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
...
<input type="numeric" id="metal" onkeyup="sync()" placeholder="Enter quantity in kgs">
...
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
statement=connection.createStatement();
String sql ="select buyprice from product where productname='Dress' ";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
...
<input type="numeric" id="dress" onkeyup="sync()" placeholder="Enter quantity in kgs">
...
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
statement=connection.createStatement();
String sql ="select buyprice from product where productname='glass' ";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
...
<input type="numeric" id="glass" onkeyup="sync()" placeholder="Enter quantity in kgs">
...
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
statement=connection.createStatement();
String sql ="select buyprice from product where productname='rubberwaste' ";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
...
<h3>Rs <%=resultSet.getString("buyprice") %></h3>
<%
int t1=Integer.parseInt(resultSet.getString("buyprice"));
}
connection.close();
} catch (Exception e) {
e.printStackTrace();
...
<input type="numeric" id="rubber" onkeyup="sync()" placeholder="Enter quantity in kgs">
...
<td><input type="number" id="paper1" name="paper1" value="" ></td>
<td>
<%
try{
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
...
if(resultSet.next()){
%>
<input type="text" name="paper2" value="<%=resultSet.getString("buyprice") %>" id="paper2"  onkeyup="mul();">
<%
}
}
catch(Exception e)
...
<td><input type="number" id="plastic1" value="" name="plastic1"></td>
<td>
<%
try{
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
...
if(resultSet.next()){
%>
<input type="text" name="plastic2" value="<%=resultSet.getString("buyprice") %>"  id="plastic2"  onkeyup="mul();">
<%
}
}
catch(Exception e)
...
<td><input type="number" id="plastic3" value="0" name="plastic3"></td>
</tr>
<tr>
<td style="color:white"><b>Metals</b></td>
<td><input type="number" id="metal1" value="" name="metal1"></td>
<td>
<%
try{
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
...
if(resultSet.next()){
%>
<input type="text" name="metal2" value="<%=resultSet.getString("buyprice") %>"  id="metal2"  onkeyup="mul();">
<%
}
}
catch(Exception e)
...
<td>
<input type="number" id="metal3" value="0" name="metal3"></td>
</tr>
...
if(resultSet.next()){
%>
<input type="text" name="dress2" value="<%=resultSet.getString("buyprice") %>" id="dress2"  onkeyup="mul();">
<%
}
}
catch(Exception e)
...
<td><input type="number" id="dress3" value="0" name="dress3"></td>
</tr>
<tr>
<td style="color:white"><b>Glasses</b></td>
<td><input type="number" id="glass1" value="" name="glass1"></td>
<td>
<%
try{
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
...
if(resultSet.next()){
%>
<input type="text" name="glass2" value="<%=resultSet.getString("buyprice") %>" id="glass2"  onkeyup="mul();">
<%
}
}
catch(Exception e)
...
<td><input type="number" id="glass3" value="0" name="glass3"></td>
</tr>
<tr>
<td style="color:white"><b>Rubber waste</b></td>
<td><input type="number" id="rubber1" value="" name="rubber1" ></td>
<td>
<%
try{
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
...
if(resultSet.next()){
%>
<input type="text" name="rubber2" value="<%=resultSet.getString("buyprice") %>" id="rubber2"  onkeyup="mul();">
<%
}
}
catch(Exception e)
...
<td>
<input type="number" id="rubber3" value="0" name="rubber3">
</td>
</tr>
<tr>
<td></td>
...
<td><input type="total" id="total" name="total" ></td>
...
<button type="submit" style="padding:10px 50px;  text-align:center; cursor:pointer; margin:0 auto;background-color:orange;" onClick="parent.location='paymentmode.jsp'">Submit</button></td>
