...
public class sellprocess extends HttpServlet
{
    public void doGet(HttpServletRequest request,HttpServletResponse response)throws IOException,ServletException
    {
     ...
     // out.println(paperp);
      ...
      co=DBConnect.getCon();
      pst=co.prepareStatement("insert into purchaseorder (name,phno,address,area,paperq,paperp,papersu,plasticq,plasticp,plasticsu,metalq,metalp,metalsu,dressq,dressp,dresssu,glassq,glassp,glasssu,rubberq,rubberp,rubbersu,total,paid_or_not,collected_or_not,willcollect) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
      ...
      co.close();
      RequestDispatcher rd=request.getRequestDispatcher("paymentmodeseller.jsp");
